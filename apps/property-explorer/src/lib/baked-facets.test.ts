...
describe("deriveBakedCardModel — layer absence verdicts (P-63 Track B)", () => {
  ...
  /**
   * DEPENDENCY: passes once cortex Track A serves livingAreaSqft verdict wire
   * on live metro GET. Until deploy, live probe remains red; unit fixtures above
   * pin the PE mapper contract.
   */
  it.todo(
