...
const ENDPOINT_INVENTORY: EndpointSpec[] = [
  ...
  { panel: 'Node & Graph', method: 'GET', path: '/atoms/trace/:did', proxiedRoute: '/api/spine/retrieval/atoms/trace/:did', status: 'allowed', notes: 'F1b WDLL 3 — shared fetchAtomTrace client with Parcel Trace; no second tracer' },
