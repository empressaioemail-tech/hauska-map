...
// LOCAL-WORKSPACE TILE: parcel-scoped multi-format terrain export, backed by
// the Hauska map-gate catalog tool refresh_parcel_terrain_export. No published
// @empressaio/cortex-tiles component exists for it.
