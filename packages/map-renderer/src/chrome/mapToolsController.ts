...
//
// MEASURE + DRAW + MARKER interaction controller for the shared layered map
// shell (PE + CC). Owns its own MapLibre geojson sources + layers + handlers.
// Never touches parcel browse / subject glow / envelope — substrate owns those.
//
