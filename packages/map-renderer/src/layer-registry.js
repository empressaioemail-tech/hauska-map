...
function legendEncodes(key) {
  const map = {
    ...
    "opportunity-zone-tract": "IRS §1400Z designated Opportunity Zone census tracts — CDFI Fund designation list joined to U.S. Census Bureau TIGER/Line 2010 tract polygons. Every rendered tract carries designation + geometry source and vintage on its properties.",
