...
export const LAYER_REGISTRY = [
  ...
  { key: "topography-contours", label: "Contours (3DEP)", group: "terrain", fixture: false, live: true, fuelGated: false },
  { key: "hydrology-flow", label: "Hydrology flow (fixture)", group: "hydrology", fixture: true, live: false, fuelGated: false },
...
function legendEncodes(key) {
  const map = {
    ...
    "topography-contours": "Live elevation contours from the engine map-layers slot (USGS 3DEP-derived, 1 m interval). NOT the Bastrop 1-ft LiDAR — that authoritative tier is served only through the DXF/site-plan export path.",
    "hydrology-flow": "D8 flow channels — NOT wired live: the engine D8 is a multi-step drainage call, not yet a bbox map-servable GeoJSON layer. Shown as fixture pending an engine hydrology map endpoint.",
